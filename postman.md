GET http://localhost:8080/api/products - name: GET All Products -
GET http://localhost:8080/api/products?limit=2 - name: GET Limit Products -
GET http://localhost:8080/api/products/ID - name: GET One Product

POST http://localhost:8080/api/products - name: Add Product Code IPad109
body:
        {
...
POST http://localhost:8080/api/products - name: Add Product Code SGXS9
body:
        {
...
POST http://localhost:8080/api/products - name: Add Product Code LNV4
body:
        {
...
POST http://localhost:8080/api/products - name: Add Product Code CSGA235G
body:
        {
...
POST http://localhost:8080/api/products - name: Add Product Code CSGA34
body:
        {
...
POST http://localhost:8080/api/products - name: Add Product Code CXMi11
body:
        {
...
POST http://localhost:8080/api/products - name: Add Product Code HWH5602
body:
        {
...
POST http://localhost:8080/api/products - name: Add Product Code HD320F
body:
        {
...
POST http://localhost:8080/api/products - name: Add Product Code LAGad320
body:
        {
...
POST http://localhost:8080/api/products - name: Add Product Code LAEco
body:
        {
...
PUT http://localhost:8080/api/products/ID - name: Edit Product ID
body:
        {
                "title": "Samsung Galaxy A23 5G 128GB",
                "description": "Samsung Galaxy A23 5G 128 GB awesome black 4 GB RAM",
...
DELETE http://localhost:8080/api/products/ID - name: Delete Product ID

GET http://localhost:8080/api/carts/ID - name: GET One Cart

GET http://localhost:8080/api/carts - name: GET All Carts

POST http://localhost:8080/api/carts - name: Add New Cart

POST http://localhost:8080/api/carts/IDCART/product/IDPRODUCT - name: Add Product to Cart